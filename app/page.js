  ...
  return (
    <div className="bg-gradient-to-b from-[#d8f0f0] to-[#76c6cd] min-h-screen flex flex-col items-center px-4 md:px-0">
      <div className="shadow-xl relative mb-10 w-full">
        ...
        {/* Big title */}
        <h1 className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:text-5xl font-bold text-[#000]">
          Crypto Donations
        </h1>

        {/* Subtitle */}
        <p className="absolute mt-5 top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:text-xl text-[#000] hidden md:block">
        ...
        <div className="absolute mt-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
          <button className="bg-[#76c6cd] hover:bg-[#5ba9b5] text-white py-2 px-5 rounded-lg shadow-xl transition-colors duration-300 mb-1">
            Connect Wallet
          </button>
